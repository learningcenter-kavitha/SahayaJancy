...
namespace Poster.Controllers
{
        ...
        
    {
        ...
        public PartialViewResult CommentPartial()
        {
            ...
            return PartialView("_CommentPartial", commends);
        }

        public JsonResult addNewComment(commentDTO1 commend)
        {
            try
            {
                var model = repo.AddComment(commends);
